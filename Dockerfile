...
# 1. Copy necessary files for the root installation
# Copy package.json and any lock files from root
COPY package.json package-lock.json ./
# Copy the client and server directories structure so the internal package.json files are available
# **Note:** This copies the directories with just the manifest files, minimizing size before install.
